...
static PyObject *__pyx_pf_6vector_vector_by_scalar(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_vec, double __pyx_v_scalar); /* proto */
...
static PyMethodDef __pyx_mdef_6vector_1vector_by_scalar = {"vector_by_scalar", (PyCFunction)(void*)(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_6vector_1vector_by_scalar, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6vector_1vector_by_scalar(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    PyObject **__pyx_pyargnames[] = {&__pyx_n_s_vec,&__pyx_n_s_scalar,0};
    if (__pyx_kwds) {
      Py_ssize_t kw_args;
      switch (__pyx_nargs) {
        case  2: values[1] = __Pyx_Arg_FASTCALL(__pyx_args, 1);
      ...
      switch (__pyx_nargs) {
        ...
        if (likely((values[1] = __Pyx_GetKwValue_FASTCALL(__pyx_kwds, __pyx_kwvalues, __pyx_n_s_scalar)) != 0)) {
          ...
          __Pyx_RaiseArgtupleInvalid("vector_by_scalar", 1, 2, 2, 1); __PYX_ERR(1, 4, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        const Py_ssize_t kwd_pos_args = __pyx_nargs;
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values + 0, kwd_pos_args, "vector_by_scalar") < 0)) __PYX_ERR(1, 4, __pyx_L3_error)
      }
    ...
    __pyx_v_vec = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_vec.memview)) __PYX_ERR(1, 6, __pyx_L3_error)
    __pyx_v_scalar = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_scalar == (double)-1) && PyErr_Occurred())) __PYX_ERR(1, 6, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("vector_by_scalar", 1, 2, 2, __pyx_nargs); __PYX_ERR(1, 4, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  {
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6vector_vector_by_scalar(__pyx_self, __pyx_v_vec, __pyx_v_scalar);
...
static PyObject *__pyx_pf_6vector_vector_by_scalar(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_vec, double __pyx_v_scalar) {
  int __pyx_v_i;
 ...
 */
                            __pyx_t_4 = __pyx_v_i;
                            *((double *) ( /* dim=0 */ (__pyx_v_vec.data + __pyx_t_4 * __pyx_v_vec.strides[0]) )) *= __pyx_v_scalar;
                        }
                    }
                }
            }
 ...
 * def vector_by_scalar(double[:] vec, double scalar):
 */
  __pyx_tuple__20 = PyTuple_Pack(4, __pyx_n_s_vec, __pyx_n_s_scalar, __pyx_n_s_i, __pyx_n_s_n); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(1, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(2, 0, 0, 4, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_vector_pyx, __pyx_n_s_vector_by_scalar, 4, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(1, 4, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 * def vector_by_scalar(double[:] vec, double scalar):
 */
  __pyx_t_7 = __Pyx_CyFunction_New(&__pyx_mdef_6vector_1vector_by_scalar, 0, __pyx_n_s_vector_by_scalar, NULL, __pyx_n_s_vector, __pyx_d, ((PyObject *)__pyx_codeobj__21)); if (unlikely(!__pyx_t_7)) __PYX_ERR(1, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_vector_by_scalar, __pyx_t_7) < 0) __PYX_ERR(1, 4, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
